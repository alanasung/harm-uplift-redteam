"""Experiment stages for Measuring Harm Uplift on Dangerous Knowledge Queries."""
...
from .harmup._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(out / "report.json", {"headline": "Measuring Harm Uplift on Dangerous Knowledge Queries", "claims_gated": True})
