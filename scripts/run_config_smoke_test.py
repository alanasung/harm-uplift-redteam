...
def _compose(preset: str | None, overrides: list[str]):
    from harmup.configs.loader import load_config
...
def _smoke_one(preset: str | None, args: argparse.Namespace) -> int:
    from harmup.configs.loader import save_resolved_config
    from harmup.utils.git import git_state
...
def main(argv: list[str] | None = None) -> int:
    ...
    from harmup.configs.loader import available_presets
