...
This note situates **Measuring Harm Uplift on Dangerous Knowledge Queries** against the mentor-linked literature for
[Measuring Harm Uplift on Dangerous Knowledge Queries](https://github.com/alanasung/harm-uplift-redteam).

## Positioning

Build a local red-team harness that measures uplift on dangerous-knowledge style queries with safety gates.

The design hypothesis is: Build a local red-team harness that measures uplift on dangerous-knowledge style queries with safety gates.
